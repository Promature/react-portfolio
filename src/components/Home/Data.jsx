...
export default function Data() {
    return (
        <div className="home__data">
            <h1 className="home__title">Kedar Pawar
                <svg
                    width="36"
                    height="36"
                    viewBox="0 0 48 48"
                ...
                <p className="home__description">
                    Computer Engineering third year student. Proficient in Django, Python, Flask, React.js, and SQL. Eager to contribute in a collaborative environment, I'm ready to make a meaningful impact with my technical expertise. Let's connect and explore the possibilities!
                </p>
